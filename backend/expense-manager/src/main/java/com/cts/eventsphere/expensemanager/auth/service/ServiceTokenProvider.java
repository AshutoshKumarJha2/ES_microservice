...
import com.cts.eventsphere.expensemanager.auth.client.ServiceTokenClient;
import com.cts.eventsphere.expensemanager.auth.dto.ServiceTokenRequest;
import com.cts.eventsphere.expensemanager.auth.dto.ServiceTokenResponse;
...
public class ServiceTokenProvider {
    ...
    @Value("${service.name:expense-manager}")

...
import com.cts.venue_manager.auth.client.IAMClient;
import com.cts.venue_manager.auth.dto.UserPrincipal;
import com.cts.venue_manager.auth.dto.ValidateResponse;
...
class AuthServiceTest {
    ...
    void validate_validToken_returnsUserPrincipal() {
        ...
        assertThat(result.role()).isEqualTo("VENUE_MANAGER");

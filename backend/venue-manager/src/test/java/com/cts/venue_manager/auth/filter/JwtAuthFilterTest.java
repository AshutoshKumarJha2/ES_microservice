package com.cts.venue_manager.auth.filter;

import com.cts.venue_manager.auth.dto.UserPrincipal;
import com.cts.venue_manager.auth.service.ServiceTokenValidator;
import com.cts.venue_manager.auth.service.UserTokenValidator;
...
class JwtAuthFilterTest {
    ...
    void doFilter_validToken_setsSecurityContextAndContinues() throws Exception {
        UserPrincipal principal = new UserPrincipal("u-1", "VENUE_MANAGER", List.of());

...
class AuthServiceTest {
    ...
    class InvalidHeader {
        ...
        @Test
        @DisplayName("throws 401 when header does not start with 'Bearer '")
    ...
    class HappyPath {
        ...
        void validate_happyPath_returnsUserPrincipal() {
            ...
            body.setUserRole("ADMIN");
            when(iamClient.validate(BEARER_TOKEN)).thenReturn(ResponseEntity.ok(body));
    ...
    class NonOkResponse {
        ...
        @Test
        @DisplayName("throws 401 when IAM returns 200 with null body")
        void validate_nullBody_throws401() {
            when(iamClient.validate(BEARER_TOKEN)).thenReturn(ResponseEntity.ok(null));

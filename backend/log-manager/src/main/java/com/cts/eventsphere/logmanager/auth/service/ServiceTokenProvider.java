...
import com.cts.eventsphere.logmanager.auth.client.ServiceTokenClient;
import com.cts.eventsphere.logmanager.auth.dto.ServiceTokenRequest;
import com.cts.eventsphere.logmanager.auth.dto.ServiceTokenResponse;
...
public class ServiceTokenProvider {
    ...
    @Value("${service.name:log-manager}")

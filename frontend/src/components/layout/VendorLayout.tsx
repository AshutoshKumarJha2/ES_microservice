    ...
    <div style={{ background: 'var(--bg-page)', minHeight: '100vh' }}>
      ...
      <Navbar expand="md" className="es-app-header border-bottom py-2" style={{ minHeight: 56 }}>
        <Container fluid className="px-3 px-md-4">
          ...
          <Navbar.Toggle aria-controls="vendor-main-nav" />

          <Navbar.Collapse id="vendor-main-nav">
            <Nav className="me-auto">
              {[
                ...
                <NavLink
                  ...
                  className={({ isActive }) => `nav-link small${isActive ? ' fw-semibold' : ''}`}
                >
                  {label}
                </NavLink>
              ))}

...
import styles from '../../../css/events/CreateEvent.module.css'
...
export const CreateEvent = () => {
  ...
  return (
    <div className={styles.page}>
      ...
      <p className={styles.sub}>Fill in the details below to {isEdit ? 'update' : 'create'} your event.</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {sessions.map((session) => (
            <div key={session.localId} className={styles['session-row']}>
              ...
              <div className={styles.field}>
                <label>Time Slot (HH:MM-HH:MM)</label>
                <input
                  type="text"
          ...
          <div className={styles['form-footer']}>
            ...
            <button type="button" className={styles['btn-cancel']} onClick={() => navigate('/organizer/dashboard')}>
              Cancel
            </button>
          </div>
        </form>
